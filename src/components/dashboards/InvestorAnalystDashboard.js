// InvestorAnalystDashboard.js - Investment Analyst Dashboard
...
// ============================================
const CallCard = ({ call, onBid, onView }) => {
...
// ============================================
const PortfolioItem = ({ investment }) => {
  return (
...
const InvestorAnalystDashboard = () => {
  ...
  const loadData = async (showRefresh = false) => {
    ...
    try {
      ...
      setAvailableCalls(dashboardData?.availableCalls || dashboardData?.capitalCalls || []);
    } catch (error) {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-emerald-100 mt-1">
              {tenant?.name || 'Investor'} • {availableCalls.length} opportunities available
            </p>
          </div>
